...
/**
 * 7-Platform Screenshot Capture Script
 *
 * Captures screenshots for the 7 core platforms in both light and dark themes
 * Platforms: twitter, discord, instagram, telegram, signal, whatsapp, mastodon
 *
 * Usage: node screenshots/capture-7-platforms.js
 */
...
// The 7 platforms to screenshot (matching bf-3ixm9 dark theme verification)
const PLATFORMS_TO_SCREENSHOT = [
  'twitter', 'discord', 'instagram', 'telegram', 'signal', 'whatsapp', 'mastodon'
];

const TEST_URL = 'http://127.0.0.1:8080/test-all-platforms-theme-switching.html';

// Screenshot output directory
const SCREENSHOTS_DIR = path.join(__dirname, '7-platforms-verification');
...
async function captureAllScreenshots() {
  console.log('🚀 Starting 7-platform screenshot capture...');
  ...
  try {
    ...
    const resultsPath = path.join(__dirname, 'test-results', '7-platform-capture-results.json');
