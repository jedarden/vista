...
function buildContextFrame(platformId, content, theme = 'dark') {
  ...
  // Use cardHTML if available (generated by renderPlatformCard), otherwise build platform-specific preview
  let linkPreview = content.cardHTML || '';
  if (!linkPreview && content.title) {
